function ImageDescriptor(file,parser){
  ...
  this.colorTableSize = Math.pow(2,file.binToInt(this.packedBits.slice(5,7))+1);
  console.log(this);
  ...
  var point = this.blocks[0][0]
    console.log("point",point.toString(2));
    //point = point>>2;

  //console.log("first point",this.blocks[0][0])
