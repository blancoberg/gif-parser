...
LZW = new function(){
    ...
    */
    ...
    for(var i = 0;i<array.length;i++){
      ...
      //  this.codeTable[bufferId] = this.buffer;
        ...
        if((code.toString(2).length) > codeSize  ){
          codeSize++;
    ...
    console.log("encode output",this.minimumCodeSize,this.output,"sizes",sizes)
    var newStream = [];
    var bit = 0;
    ...
    console.log("new code lenght",this.encodingTable.length);
  ...
  this.decode = function(byteArray,minimumCodeSize){
    ...
    console.log("lzw.decode",byteArray,this.output,code)
    return this.output;
